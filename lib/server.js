...
app.get('/api/config/client-standard', (req, res) => {
    try {
        ...
        logger.error('Error loading client standard config:', error);
        res.status(500).json({ error: 'Failed to load standard configuration' });
    }
});
app.get('/api/config/client-specific', (req, res) => {
    try {
        ...
        logger.error('Error loading client specific config:', error);
        res.status(500).json({ error: 'Failed to load specific configuration' });
    }
});
app.post('/api/config/client-specific', (req, res) => {
    try {
        ...
        logger.error('Error saving client specific config:', error);
