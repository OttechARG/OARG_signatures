...
export async function callMutationUploadPdfBase64(base64) {
...
export function showPdfWithOptions(blob) {
...
export async function getDocumentBase64WithRetries(url, maxIntentos = 3) {
...
export function addTextBox(coordinates, pageNum, text = "", fontSize = 12) {
...
export function renderTextBoxes(pageNum) {
